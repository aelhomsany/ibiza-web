...
describe('EditSubscriptionModal', () => {
  ...
  it('[P0] renders prefilled subscription fields', () => {
    ...
    expect(
      [...screen.getByTestId<HTMLSelectElement>('edit-subscription-plan').options].map((o) => o.value),
    ).toEqual(['FREE', 'GROWTH', 'INTERNAL'])
  })
  ...
  it('[P0] submit calls update subscription mutation with form payload', async () => {
    ...
    await user.selectOptions(screen.getByTestId('edit-subscription-plan'), 'GROWTH')

    ...
    vi.mocked(apiClient.getPlatformOrganizations).mockResolvedValue([
      {
        ...
        name: 'Free At Limit',
        primaryContact: 'Jordan Lee',
        initialOrganizationAdminEmail: 'jordan@free.example',
        plan: 'FREE',
        userCount: 3,
        userLimit: 3,
        status: 'ACTIVE',
      ...
      },
      {
        ...
        primaryContact: 'Fatima Hassan',
        initialOrganizationAdminEmail: 'fatima@growth.example',
        plan: 'GROWTH',
        userCount: 199,
        userLimit: 200,
        status: 'ACTIVE',
      ...
      },
      {
        ...
        initialOrganizationAdminEmail: 'avery@growth.example',
        plan: 'GROWTH',
        userCount: 200,
        userLimit: 200,
        status: 'ACTIVE',
      ...
      },
      {
        ...
        initialOrganizationAdminEmail: 'sam@internal.example',
        plan: 'INTERNAL',
        userCount: 10000,
        userLimit: 9999,
        status: 'ACTIVE',
      ...
      },
      {
        ...
        initialOrganizationAdminEmail: 'mona@over.example',
        plan: 'FREE',
        userCount: 4,
        userLimit: 3,
        status: 'ACTIVE',
